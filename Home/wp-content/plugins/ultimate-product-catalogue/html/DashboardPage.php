							...
							<div id="upcp_pro" class="postbox " >
									...
									<h3 class='hndle'><span><?php _e("Thank You!", 'UPCP') ?></span></h3>
							 		<div class="inside">
											...
											<?php } elseif ($Full_Version == "Yes") { ?><ul><li><?php _e("Thanks for upgrading to version 3.1!", "UPCP"); ?><br> <a href='http://www.facebook.com/EtoileWebDesign'><?php _e("Follow us on Facebook", "UPCP"); ?></a> <?php _e("to suggest new features or hear about upcoming ones!", "UPCP");?> </li></ul>
											<?php } else { ?><ul><li><?php _e("Thanks for upgrading to version 3.1!", "UPCP"); ?><br> <?php _e("Love the plugin but don't need the premium version? Help us speed up product support and development by donating. Thanks for using the plugin!", "UPCP");?>
